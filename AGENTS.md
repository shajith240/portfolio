# AGENTS.md — kalyp.so Portfolio Clone
...
```
"Read @MASTER.md and @AGENTS.md — we are on Step [N]: [ComponentName]. Build only this component. After building, take a screenshot and compare against the reference specs in MASTER.md. Do not proceed until the comparison passes."
```
